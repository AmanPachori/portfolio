...
const Card1 = ({e}) => {
  return (
    <div className="row p-3 my-1">
      <div className="order-sm-first order-lg-2 col-lg-6 my-2 py-3 col-sm-12 projectInfo d-flex flex-column align-items-center justify-content-center">
      ...
      <div className="order-sm-2  order-lg-1 col-lg-6 my-2 projects col-sm-12">
